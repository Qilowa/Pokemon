...
public class PokemonTeam implements Serializable{
	...
	public int createTeam(Pokedex p) {
		...
		System.out.println("Combien de Pok�mon voulez-vous ? (max : 6) ");
	    int nb = sc.nextInt();
	    while(nb > 6 || nb < 1) {
			System.out.println("incorrect r�assayez");
			System.out.println("Combien de Pok�mon voulez-vous ? (max 6) ");
		    int nb1 = sc.nextInt();
		    if (nb1<=6 && nb1>=1) {
				nb=nb1;
		...
		//chouissisez vos capacit� et -1 pour break 
		...
		for (int i = 0; i <nb; i++) {
		  ...
		  //condition scanner quand on rentre de la merde
		    ...
		    System.out.println("Vous avez saisi le Pok�mon : " + p.getPokemon(pk));
		    ...
		    System.out.println("Vous avez saisi la Capacit� : " + capacitylist.get(cp1));
		    pokemon.addCapacity(capacitylist.get(cp1));
		    //pokemon.addpacity(capacity[cp1]);
		    
		    System.out.println("Choissisez votre 2�me capacit� (id) (-1 pour ne plus en choisir) : ");
		    int cp2 = sc.nextInt();
		    ...
		    while(cp3 > (capacitylist.size()-1) || cp3 < -1) {
				System.out.println("incorrect r�assayez");
				System.out.println("Choissisez votre 3�me capacit� (id) (-1 pour ne plus en choisir) : ");
			    int cptest = sc.nextInt();
			    if (cptest < capacitylist.size() && cptest > -1) {
			    	cp3=cptest;
					break;
		    ...
		    System.out.println("Vous avez saisi la Capacit� : " + capacitylist.get(cp3));
		    pokemon.addCapacity(capacitylist.get(cp3));
		    //pokemon.addpacity(capacity[cp3]);
		    
		    
		    System.out.println("Choissisez votre 4�me capacit� (id) (-1 pour ne plus en choisir) : ");
		    int cp4 = sc.nextInt();
		    ...
		    System.out.println("Vous avez saisi la Capacit� : " + capacitylist.get(cp4));
	    ...
	    System.out.println("Voici vos pok�mons : ");
